...
![Figure 4: A plot showing the ordered list of Eigenvalues (lambda_i) versus Mode Number i. The eigenvalues decrease rapidly, showing a 'kink' around Mode Number 10, indicating a transition in the signal-to-noise ratio of the eigenmodes.](c397c8d13a885b05543b490ca9317118_img.jpg)

Figure 4: A plot showing the ordered list of Eigenvalues (lambda\_i) versus Mode Number i. The eigenvalues decrease rapidly, showing a 'kink' around Mode Number 10, indicating a transition in the signal-to-noise ratio of the eigenmodes.
...
$$C_{ij}=U_{ik}^\dagger D_{kl}V_{lj},$$
 (15)
...
As discussed in the Introduction, there is recent evidence for excessive bulk flow motions compared to the WMAP5-normalised  $\Lambda$ CDM model [18] and therefore, it is important to confirm these results as it may indicate
