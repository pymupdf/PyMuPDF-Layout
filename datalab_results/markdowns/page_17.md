...
Figure 2 displays two graphs illustrating treatment response functions. The left graph, titled "Concave Treatment Response Function," shows the Potential Outcome  $Y_1$  increasing with the Treatment Level  $t$  at an increasing rate (concave shape). The right graph, titled "Convex Treatment Response Function," shows the Potential Outcome  $Y_1$  increasing with the Treatment Level  $t$  at a decreasing rate (convex shape).

Figure 2: Concave treatment response and convex treatment response

Concavity and convexity of the treatment response function imply  $\Pr\left(\frac{Y_0-W}{t_0-t_W}\ge\frac{Y_1-Y_0}{t_1-t_0},Y_1\ge Y_0\ge W\right)=1$  and  $\Pr\left(\frac{Y_0-W}{t_0-t_W}\ge\frac{Y_1-Y_0}{t_1-t_0},Y_1\ge Y_0\ge W\right)=1$ , respectively, where  $t_d$  is a level of input for each treatment status  $d\in\{0,1\}$  while  $t_W$  is a level of input without the treatment and  $t_W < t_0 < t_1$ . Given  $W=w$ , concavity and convexity of the treatment response function restrict the support of  $(Y_0, Y_1)$  to the region below the straight line  $Y_1=\frac{t_1-t_W}{t_0-t_W}Y_0-\frac{t_1-t_0}{t_0-t_W}w$  and above the straight line  $Y_1=Y_0$ , and to the region above two straight lines  $Y_1=\frac{t_1-t_W}{t_0-t_W}Y_0-\frac{t_1-t_0}{t_0-t_W}w$  and  $Y_1=Y_0$ , respectively, as shown in Figures 1(b) and (c).
...
$$D=1\left\{Y_1-Y_0\ge\mu_C(Z)\right\},$$

where  $\mu_C(Z)$  represents nonpecuniary costs with a vector of observables  $Z$ . Then treated ( $D=1$ ) and untreated people ( $D=0$ ) are the observed groups satisfying support restrictions  $\{Y_1=Y_0\ge\mu_C(Z)\}$  and  $\{Y_1=Y_0<\mu_C(Z)\}$ , respectively.
...
$$\Pr\left\{Y_1-Y_0\le\delta|(Y_0,Y_1)\in C\right\}.$$