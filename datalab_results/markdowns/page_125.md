...
$$\text{CH}_2\text{C}(\text{Rx})\text{C}(\text{O})\text{O}\text{Fa}\text{Fb}\text{Fc}(\text{F}_1)_{p1}$$
...
$$\text{CH}_2\text{C}(\text{CH}_3)\text{C}(\text{O})\text{O}\text{Fa}\text{Fb}\text{Fc}(\text{F}_1)_{p1}$$
