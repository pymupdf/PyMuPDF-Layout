...
Diagram illustrating SMFG's Risk Management System, showing the governance structure and risk management departments across the Group.

**Group Governance Structure (Left):**
...
The Governance structure provides **Guidance for drafting of basic policies** and **Monitoring** to the Group companies.

**Group Companies (Center):**
...
These companies provide **Report** back to the Governance structure.

**Group Governance Structure (Right):**

- Board of Directors
- Management Committee (includes Credit Risk Management Committee and Market Risk Management Committee)
- Designated Board Members (includes Board Member in Charge of Risk Management Unit)
- Corporate Auditors
- External Audit
- Internal Audit Unit

**Bank-wide Risk Management (Bottom Right):**
...
Risk categories managed include: Credit Risk, Market Risk, Liquidity Risk, Operational Risk, Processing Risk, System Risk, Settlement Risk, and Other Risks.

**Corporate-wide Risk Management (Bottom Left):**
...
Risk categories managed include: Credit Risk, Market Risk, Liquidity Risk, Operational Risk, Processing Risk, and System Risk.