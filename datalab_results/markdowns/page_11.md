...
$$f_\lambda(\mathcal{N})\equiv\max_{\rho^{XBE}}I(X;B)+\lambda I(A|BX).$$
...
$$\rho^{XABE}\equiv\sum_x p_X(x)|x\rangle\langle x|^X\otimes U_\mathcal{N}^{A^\prime\rightarrow BE}(\phi_x^{AA^\prime}),$$
$$\theta^{XABE}\equiv\sum_x p_X(x)|x\rangle\langle x|^X\otimes U_\mathcal{N}^{A^\prime\rightarrow BE}(\varphi_x^{AA^\prime}),$$

*$U_\mathcal{N}^{A^\prime\rightarrow BE}$  is an isometric extension of  $\mathcal{N}$ ,  $\varphi_x^{A^\prime}=\Delta(\varphi_x^{A^\prime})=\Delta(\phi_x^{A^\prime})$ , and  $\Delta$  is the completely dephasing channel.*
...
$$\sigma^{XAYE}\equiv\sum_x p_X(x)|x\rangle\langle x|^X\otimes(\Delta^{B\rightarrow Y}\circ U_\mathcal{N}^{A^\prime\rightarrow BE})(\phi_x^{AA^\prime}).$$

Then the following chain of inequalities holds for all  $\lambda\ge 1$ :

$$I(X;B)_\rho+\lambda I(A|BX)_\rho$$
...
$$\frac{1}{2}|0\rangle\langle 0|^X\otimes\psi_0^{AA^\prime}+\frac{1}{2}|1\rangle\langle 1|^X\otimes\psi_1^{AA^\prime},$$
 (D1)

*where  $\psi_0^{AA^\prime}$  and  $\psi_1^{AA^\prime}$  are pure states, defined as follows for  $\mu\in[0,1/2]$ :*

$$\mathrm{Tr}_A\left\{\psi_0^{AA^\prime}\right\}=\mu|0\rangle\langle 0|^{A^\prime}+(1-\mu)|1\rangle\langle 1|^{A^\prime},$$
(D2)

$$\mathrm{Tr}_A\left\{\psi_1^{AA^\prime}\right\}=(1-\mu)|0\rangle\langle 0|^{A^\prime}+\mu|1\rangle\langle 1|^{A^\prime}.$$
(D3)
