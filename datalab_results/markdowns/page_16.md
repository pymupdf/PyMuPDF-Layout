...
![A phase plane plot showing trajectories of a system. The horizontal axis is y_1 and the vertical axis is y_2. The plot shows several trajectories (red and blue arcs) starting near the boundary y_1=0 and moving towards a periodic solution (a closed curve) as time increases. The trajectories are slightly curved and approach the periodic solution from the left side.](770fa0497770252dc22b4fa902ebb384_img.jpg)

A phase plane plot showing trajectories of a system. The horizontal axis is y\_1 and the vertical axis is y\_2. The plot shows several trajectories (red and blue arcs) starting near the boundary y\_1=0 and moving towards a periodic solution (a closed curve) as time increases. The trajectories are slightly curved and approach the periodic solution from the left side.
...
$$\begin{aligned}x'_1 &= x_2, \\x'_2 &= -0.0001[x_2^2 + (x_1 - 1)^2 - 1]x_2 - x_1 + 1, \\ \Delta x_2|_{x \in \Gamma} &= -(1 + Rx_2)x_2,\end{aligned}\tag{5.71}$$
