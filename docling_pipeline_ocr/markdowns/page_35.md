...
| Grass weight,  Ibs.  Limit  load  Ultimate  factor  l oad factor  20,wO (basic).  5.60  8.40  30,003  (max. rakcoff).  3.73  5.60  13,333  (min.  f' cl):.  8.40  12.60   |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
An=change in  load  factor due to gust m=lift curve  slope, unit of  C, per degree of  01 o=altitude density  ratio W/S=  wing loading, psf V. = equivalent airspeed,  knots
