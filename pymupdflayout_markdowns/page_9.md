...
**==> formula [295 x 59] intentionally omitted <==**

and the inverse covariance matrix 

**==> formula [11 x 13] intentionally omitted <==**

**==> formula [339 x 59] intentionally omitted <==**
...
**==> picture [267 x 1] intentionally omitted <==**

|Models|�χ2<br>sn,min|χ2<br>cmb,min|χ2<br>bao,min|χ2<br>H,min|χ2<br>total,min|
|---|---|---|---|---|---|
