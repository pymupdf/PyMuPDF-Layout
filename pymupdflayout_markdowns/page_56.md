...
If it is impossible to restore the communication within two working days, one party must _notify_ the other that alternative means of communication specified in Article II.5.1 will be used until the _supplier portal_ or the machine-to-machine connection is restored. 
