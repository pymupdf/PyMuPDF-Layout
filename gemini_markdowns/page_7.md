where
$$
A = \frac{(x_3^2 + y_2^2)^d |x_3^2 + (y_3 - y_1)^2|^d}{(x_3^2 + (y_2 - y_1)^2)^d (x_3^2 + y_3^2)^d} \quad \text{(A9)}
$$
$$
B = \frac{[(x_3 - x_1)^2 + (y_2 - y_1)^2]^d}{(x_3 - x_1)^{2d}} \times \frac{[(x_3 - x_1)^2 + (y_3 - y_2)^2]^d}{[(y_3 - y_1)^2 + (x_3 - x_1)^2]^d} \quad \text{(A10)}
$$
and
$$
C = \frac{|x_1^2 + y_1^2|^d |x_1^2 + (y_2 - y_1)^2|^d}{|x_1|^{2d} |y_2^2 + x_1^2|^d} \quad \text{(A11)}
$$
We write
$$
ABC - B - C + 1 = (A - 1)BC + (B - 1)(C - 1) \quad \text{(A12)}
$$
...
$$
\Sigma^{(6)} = 2di \frac{(Ja^d)^6 \Gamma(5 - 6d)}{(-i(\omega - k_y))^{5 - 6d}} \times \int_0^\infty \prod_{i=1}^3 d\xi_i \frac{\xi_1^{1 - 2d} \xi_2^{1 - 2d} \xi_3^{1 - 2d}}{(\alpha + \xi_1 + \xi_2 + \xi_3)^{5 - 6d}} \quad \text{(A13)}
$$
...
$$
\frac{\partial \Sigma^{(6)}}{\partial \alpha} = -2di \alpha^{-1} \frac{(Ja^d)^6 \Gamma(6 - 6d)}{(-i(\omega - k_y))^{5 - 6d}} \times \int_0^\infty \prod_{i=1}^3 d\xi_i \frac{\xi_1^{1 - 2d} \xi_2^{1 - 2d} \xi_3^{1 - 2d}}{(1 + \xi_1 + \xi_2 + \xi_3)^{6 - 6d}} \quad \text{(A14)}
$$
The remaining integrals are easily evaluated. The subsequent integration over $\alpha$ restores the singularity in the

self energy correction,
$$
\Sigma^{(6)} = 2d \frac{-i(Ja^d)^6 \Gamma(1 - 2d) \Gamma^2(2 - 2d)}{(-i(\omega - k_y))^{5 - 6d}} \times (\log \alpha + C) \quad \text{(A15)}
$$
...
$$
\Sigma^{(4)} = i(Ja^d)^4 \int_0^\infty d\xi \int_0^1 d\eta \frac{\Gamma(3 - 4d) \eta^{-2d} (1 - \eta)^{-2d}}{[(-i((\omega - k_y) + (\omega - k_x)\xi))]^{3 - 4d}} \times \left[ \frac{|(1 - \eta)^2 + \xi^2|^d |\eta^2 + \xi^2|^d}{|1 + \xi^2|^d |\xi|^{2d}} - 1 \right] \quad \text{(B1)}
$$
...
$$
\Sigma^{(4)} = \frac{i(Ja^d)^4 \Gamma(1 - 2d) \Gamma(2 - 2d) \alpha^{2 - 2d}}{(-i(\omega - k_x))^{3 - 4d}} \quad \text{(B2)}
$$
