1. Master Data Management (bespoke or commercial solution) – minimum 1 reference
2. BPMN, UML (or equivalent) – minimum 3 references
3. RUP, Prince2 or equivalent waterfall methodology – minimum 2 references
4. Agile/Scaled Agile Framework – minimum 3 references
...
**Minimum level of capacity:** The tenderer must be certified in the following ISO standards in the areas covered by this call for tenders:
