...
![Figure A: 2004 Exploration Expenditure by Category](placeholder-figure-A.png)

**Figure A (summary): 2004 Exploration Expenditure by Category.**
This pie chart illustrates the breakdown of exploration expenditure by category:
*   Drilling: $63.6 million
*   Geoscience and other: $37.5 million
*   Seismic: $17.2 million
*   New ventures: $7.3 million

![Figure B: 2004 Exploration Expenditure by Region](placeholder-figure-B.png)

**Figure B (summary): 2004 Exploration Expenditure by Region.**
This pie chart illustrates the breakdown of exploration expenditure by region:
*   Offshore Australia: $32.6 million
*   Onshore Australia: $23.4 million
*   South East Asia: $41.4 million
...
![Figure C: Kutei Basin Map](placeholder-figure-C.png)

**Figure C (summary): Kutei Basin Map.**
This map shows the Kutei Basin region including parts of Kalimantan and Sulawesi, separated by the Makassar Strait. Key locations include Bontang, Santan, Samarinda, Senipah, Balikpapan, Apar Bay, and Palu. Several Production Sharing Contracts (PSCs) are highlighted: Popodi PSC, Donggala PSC (which contains Hiu Aman), and Papalang PSC. The map legend indicates the presence of Oil fields, Gas fields, Oil pipelines, and Gas pipelines throughout the region. A scale bar shows 0-50 kilometres.