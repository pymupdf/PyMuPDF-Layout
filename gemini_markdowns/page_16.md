...
**Figure 7 (summary):** This plot shows $y_2$ versus $y_1$. Two sets of trajectories are depicted: red arcs starting with an initial value of $(0, 1.2)$ and blue arcs starting with $(0, 1.5)$. Both sets of trajectories approach the periodic solution of system (5.60) as time increases, suggesting a convergence to a stable orbit.
...
\begin{aligned}
x_1' &= x_2 \\
x_2' &= -0.0001[x_2^2 + (x_1 - 1)^2 - 1]x_2 - x_1 + 1 \\
\Delta x_2|_{x \in \Gamma} &= -(1+Rx_2)x_2
\end{aligned}
\tag{5.71}
$$
and admits the periodic solution $\Psi_0(t) = (1+\cos(t), – \sin(t))$. By means of the equality $(\nabla\Phi(x^*), f(x^*)) = ((1,0), (0, 1)) = 0$ with $x^* = (0,0) \in \partial\Gamma$, it is easy to say that $x^*$ is a grazing point of $\Psi_0(t)$.
