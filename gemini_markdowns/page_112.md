```markdown
---
patent_id: US 2012/0003590 A1
publication_date: Jan. 5, 2012
---
...
The thickness of the film is preferably from 0.02 to 0.1 µm. The method for coating the composition on a substrate is preferably spin coating, and the spinning speed is preferably from 1,000 to 3,000 rpm.
...
![Synthesis Scheme for Resin P-14](chemical-scheme-resin-p14.png)

**Synthesis Scheme for Resin P-14 (summary):** The scheme depicts the synthesis of Resin P-14. It begins with compound (5), 4-vinylphenyl acetate, which is converted to compound (6), 4-vinylphenol. Compound (6) then reacts to form compound (7), 4-vinylphenyl nonafluorobutane-1-sulfonate. Finally, compound (7) is transformed into compound (8), the sodium salt of 4-vinylphenyl nonafluorobutane-1-sulfonate.
```