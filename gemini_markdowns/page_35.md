...
| Gross weight, lbs.       | Limit load factor | Ultimate load factor |
| :----------------------- | :---------------- | :------------------- |
...
$$
\Delta\eta = 0.115 \frac{m\sqrt{\sigma}}{(W/S)} V_e (KU)
$$

where

*   $\Delta\eta$ = change in load factor due to gust
*   $m$ = lift curve slope, unit of $C_L$ per degree of $\alpha$
*   $\sigma$ = altitude density ratio
*   $W/S$ = wing loading, psf
*   $V_e$ = equivalent airspeed, knots
