...
$$
\begin{aligned}
& \underset{P_{n,k,l}}{\text{minimize}} & & \log_2 \left( \prod_{l=1}^{L} \prod_{k=1}^{K} \prod_{n=1}^{N} \left( \frac{\sigma^2 + I_{n,l}}{P_{n,k,l}h_{n,k,l} + \sigma^2 + I_{n,l}} \right)^{\alpha_{n,k,l}} \right) \\
