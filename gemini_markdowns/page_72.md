...
![Typewriter keys: D, F, G, H, J, K](placeholder-typewriter-keys-1.png)

**Image (summary):** A row of antique typewriter keys featuring the letters D, F, G, H, J, K.
...
![Typewriter keys: E, R, T, Y, U](placeholder-typewriter-keys-2.png)

**Image (summary):** A row of antique typewriter keys featuring the letters E, R, T, Y, U.