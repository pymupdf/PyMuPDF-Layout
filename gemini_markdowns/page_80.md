...
![Excel #REF! error example](excel-ref-error.png)

**Figure (summary):** This image shows an Excel spreadsheet fragment. The formula bar displays `=#REF!+L12`. Cell D contains the error `#REF!`. A red arrow points from the cell to a text box which reads "#REF! error in an Excel formula", illustrating the invalid cell reference error.
