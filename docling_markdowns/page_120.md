...
2. frequency regulation logic to change an operating frequency of the first integrated circuit, the frequency  regulation  logic  to  receive  a  signal from the program.
14. The apparatus of claim 10, further comprising:
4. voltage regulation logic to change an operating voltage of the first integrated circuit, the voltage regulation logic to receive a signal from the program.
...
2. operating the integrated circuit at the third state of performance for a transient period of time.
...
4. changing the state of performance of the integrated  circuit  by  changing  an  amount  of  processors to manage the processing load.
