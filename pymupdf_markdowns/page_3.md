|Col1|Col2|Col3|All Block<br>All Scala|
|---|---|---|---|
||~~G~~|||
|||||
||~~G~~|||
...
|Al<br>G|Col2|gorithm<br>All Block|Col4|
|---|---|---|---|
|~~**Al**~~<br>~~G~~||||
|~~**Al**~~<br>~~G~~||||
||||~~All Scala~~<br>Auto Blo|
|||||
|||||
|||||
|||||
...
to the Informed Blocking algorithm (blocking each _α_ _i_, _β_ _i_ pair), which produces a tenfold improve

ment in Efficiency over the most efficient static algorithm – for this model, All Scalar sampling.


The cut height _h_ = 0 _._ 1 indicates that only the _α_ _i_, _β_ _i_ pairs exhibit posterior correlations above 0.9.
