|Col1|G|Col3|AllBlock<br>AllScala|
|---|---|---|---|
|||||
||~~G~~|||
|||||
...
|Al<br>G|Col2|gorithm<br>AllBlock|Col4|
|---|---|---|---|
|~~**Al**~~<br>~~G~~||||
|~~**Al**~~<br>~~G~~||||
...
to the Informed Blocking algorithm (blocking each _αi_, _βi_ pair), which produces a tenfold improve

ment in Efficiency over the most efficient static algorithm – for this model, All Scalar sampling.

The cut height _h_ = 0 _._ 1 indicates that only the _αi_, _βi_ pairs exhibit posterior correlations above 0.9.
