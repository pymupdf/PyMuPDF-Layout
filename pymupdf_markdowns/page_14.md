...
( _p_ ( _wi|wi−_ 1)), then it will also be difficult to learn a good
...
the class transition probabilities ( _p_ ( _ci|ci−_ 1)) and the word


probabilities ( _p_ ( _wi|cj_ )). Twitter data, in these experiments,
