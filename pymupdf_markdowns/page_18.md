...
**==> picture [207 x 149] intentionally omitted <==**
...
FIG. 8: (color online) Q z , position of the maximum of S(⃗q), vs. temperature for thickness n = 8. Inset: magnetic vector (m[x] l[, m][y] l[) profile for some temperatures for][ L][ = 64. Colors] and symbols as in Fig. 2. 
