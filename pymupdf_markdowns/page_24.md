Figure S1: We show the effects of Fisher transforming correlation coefficients on the range of
dynamic fluctuations in Fisher-transformed coefficients. (A) Given four levels of static functional connectivity, we show the expected range of distribution Fisher-transformed dynamic
...
Figure S2: Comparison of raw Pearson correlation coefficients with Fisher-transformed coefficients. (A) Because the Fisher transformation is monotonic (preserves rank) it does not change
percentiles in any appreciable way. The correlation of the Fisher-transformed percentile matrix with the percentile matrix obtained from raw Pearson correlation coefficients is _r ≈_ 1. (B)
