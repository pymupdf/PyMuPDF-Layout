...
K
f (p) = pn,k,lhn,k,l + σ [2] + In,l = [�][L] l=1 �k=1 [u][n,k,l][(][p][)][ and approximating the denominator][ f] [(][p][)]
...
where sn,k,l = [u][n,k,l] f (p0 [(][p] ) [0][)][. Thus, the problem can be solved by extending the single condensation]
