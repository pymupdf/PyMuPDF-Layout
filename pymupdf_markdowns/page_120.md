...
1. **16.** The apparatus of claim 10, wherein the instructions reside in an operating system. 

1. **17.** The apparatus of claim 10, wherein the instructions reside in application software. 

1. **18.** The apparatus of claim 10, wherein the first integrated circuit comprises a chip set. 

1. **19.** The apparatus of claim 10, wherein the first integrated circuit comprises a processing unit. 

1. **20.** The apparatus of claim 15, wherein the Basic Input Output System to receive a notification signal from an operating system that the user event has occurred. 

1. **21.** The apparatus of claim 14, wherein the program comprises an increasing state transition algorithm discrete from a decreasing state transition algorithm. 
...
1. **25.** The machine-readable medium of claim 23, further comprising instructions which, when executed by the machine, cause the machine to perform the further operations comprising: 
...
1. **26.** The machine-readable medium of claim 23, further comprising instructions which, when executed by the machine, cause the machine to perform the further operations comprising: 
