...
|                     | Import Mappings      |  |  |  |  |  |  |
|---------------------|----------------------|--|--|--|--|--|--|
| Select Source Host: | <br>ITSO-VMHOST-<br> |  |  |  |  |  |  |
|                     | Cancel<br>Import     |  |  |  |  |  |  |
...
| ⊕ Add Host           | : ⊟ Actions →<br>$\perp$<br>Rename |           |            | Default       | Contains ∨<br>V | Filter               |
|----------------------|------------------------------------|-----------|------------|---------------|-----------------|----------------------|
| Name                 | Assign to Host Cluster             | Host Type | # of Ports | Host Mappings | Host Cluster ID | Host Cluster Nam II! |
