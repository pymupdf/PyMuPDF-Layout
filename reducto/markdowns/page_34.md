...
AI IR and VR MTRs are shown, and may extend from the surface upwards. Only the route centerline, direction of flight along the route, and the route designator are depicted-route widths and altitudes are not shown.

DoD users refer to Area Planning AP/1B MIItary Training Routes North and South America for current routes.
