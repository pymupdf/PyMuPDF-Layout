...
2. Loosen the retention screw, then rotate the adjustment ring to change the length of the vertical tube. 3. Make sure that both the images in 
...
**==> picture [252 x 242] intentionally omitted <==**
