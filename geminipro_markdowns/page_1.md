...
\text{subject to} & \quad \sum_{n=1}^{N} \alpha_{n,k,l}p_{n,k,l} \le P_{k,\text{max}}, \quad \forall k, \forall l
\end{aligned}
\tag{12}
$$
...
$$
\sum_{l=1}^{L} \sum_{k=1}^{K} u_{n,k,l}(p) \ge \prod_{l=1}^{L} \prod_{k=1}^{K} \left( \frac{u_{n,k,l}(p)}{s_{n,k,l}} \right)^{s_{n,k,l}}
\tag{13}
$$
