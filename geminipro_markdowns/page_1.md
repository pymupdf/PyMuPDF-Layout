...
$$
\begin{aligned}
& \underset{p_{n,k,l}}{\text{minimize}} & & \log_2 \prod_{l=1}^L \prod_{k=1}^K \prod_{n=1}^N \left( \frac{\sigma^2 + I_{n,l}}{p_{n,k,l}h_{n,k,l} + \sigma^2 + I_{n,l}} \right)^{\alpha_{n,k,l}} \\
& \text{subject to} & & \sum_{n=1}^N \alpha_{n,k,l} p_{n,k,l} \leq P_{k, \max}, \quad \forall k, \forall l
\end{aligned}
\tag{12}
$$
