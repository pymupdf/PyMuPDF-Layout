US 2020/0050106 A1 | 40 | Feb. 13, 2020
---

![Chemical structures (continued)](placeholder-structures.png)

**Figure (summary):** A collection of chemical structures, continued from the previous page. The structures shown include:
- A triphenyl-imidazole derivative.
- A tertiary amine with three hydroxyl-terminated polyether arms.
- An ionic compound composed of a tetra-n-butylammonium cation and a benzoate anion.
- A zwitterionic compound (betaine type) with a quaternary ammonium cation.
- A substituted guanidine-like molecule containing cyclohexyl and morpholino groups.
- An ether-linked bis-morpholine compound.
