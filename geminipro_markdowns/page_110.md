...
$$
A = \frac{([H] \times 0.04 + [C] \times 1.0 + [N] \times 2.1 + [O] \times 30.6 + [F] \times 50.6 + [S] \times 1.5 + [I] \times 39.5)}{([H] \times 1 + [C] \times 12 + [N] \times 14 + [O] \times 16 + [F] \times 19 + [S] \times 32 + [I] \times 127)} \quad \text{Formula (1)}
$$
