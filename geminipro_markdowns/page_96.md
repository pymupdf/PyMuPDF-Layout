...
**Table 1: Eagle Ford Operations Summary**
...
**Table 2: Eagle Ford Constant Case Reserves**
*As at and for the Year Ended 31 December 2014*
...
![Net Eagle Ford Drilling Locations](net-eagle-ford-drilling-locations.png)

**Figure 1 (Summary): Net Eagle Ford Drilling Locations (excluding contingent resources)**
A combination bar and line chart spanning Jan-13, Jan-14, and Jan-15.
*   **Bars:** Show the sum of "Proved" (Blue) and "Probable and Possible" (Orange) locations. The total height of the bars increases slightly from Jan-13 to Jan-15.
*   **Line (Grey):** Represents "Drilling Inventory (Years)". The line trends upwards significantly, starting below 2.0 years in Jan-13 and rising to approximately 4.3 years in Jan-15.

![Map of Texas Eagle Ford Operations](texas-eagle-ford-map.png)

**Figure 2 (Summary): Operational Map**
A map of the Eagle Ford region in Texas outlining specific counties (Maverick, Dimmit, Atascosa, Live Oak, McMullen).
*   **Legend:**
    *   Black Dot: SEA Field Office
    *   Yellow Square: SEA Acreage
*   **Geological Zones:** The map demarcates the "Oil Window," "Volatile Oil & Condensate Window," and "Dry Gas Window" moving from northwest to southeast.