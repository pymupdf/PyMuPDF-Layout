...
![Figure: NAVAID Identification Box](placeholder-navaid-box.png)

**Figure (summary):**
A diagram of a NAVAID box (example: Pontiac VORTAC). Callouts indicate:
- **Crosshatch:** Indicates Shutdown status.
- **Frequencies:** FSS Radio Frequencies (e.g., 122.1R), NDB Frequency (379), and Channel information.
- **Operational note:** "Operates less than continuous or on-request".
- **Components:** Identifier, Morse Code, Name, and ASOS/AWOS availability.
- **Coloring:** Blue indicates VHF/UHF information.
...
![Figure: Compass Rose with NAVAID Box](placeholder-compass-rose.png)

**Figure (summary):**
A compass rose surrounding a NAVAID box (example: VOR SALEM 114.3 SVM). A note points to the center: "Open circle symbol shown when NAVAID located on airport. Type of NAVAID shown in top of box."
...
*   **[Blue symbol with runway pattern]** Hard-surfaced runways greater than 8069’ or some multiple runways less than 8069’
*   **[Magenta circular symbol]** Hard-surfaced runways 1500’ to 8069’
*   **[Blue open circle]** Other than hard-surfaced runways
*   **[Anchor symbol]** Seaplane bases

**Military airports:**

*   **[Double concentric circle]** Other than hard-surfaced runways
...
*   **[Airport symbol with tick marks]** Fuel availability indicated by use of tick marks around the basic airport symbol. Consult Chart Supplement for details and availability.

**Other airports with or without fuel:**

*   (Symbols displayed: Circles containing letters **H**, **F**, **U**, **R**, and a circle containing an **X**)