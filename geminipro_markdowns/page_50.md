---
title: Invitation to Tender - ENISA F-COD-20-T03
date: 2020-03-13
---

![ENISA Logo](placeholder-enisa-logo.png)
...
**Expiry date and time:** **13th March 2020 at 18:00 (CET) Central European time**
...
In order to submit a tender using e-Submission, economic operators (each member of the group in the case of a joint tender) will need to register in the European Commission's [Participant Register](https://ec.europa.eu/info/funding-tenders/opportunities/portal/screen/how-to-participate/participant-register) - an online register of organisations participating in EU calls for tenders or proposals. On registering each organisation obtains a Participant Identification Code (PIC, 9-digit number) which acts as its identifier.
