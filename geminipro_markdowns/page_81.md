...
2. This instrument should only be used in an environment with an indoor temperature range of $32^\circ\text{F}$ to $104^\circ\text{F}$.
...
![Microscope Models AY11240 and AY11238 Diagrams](placeholder-microscope-diagrams.png)

**Figure Summary (Component Labels):**

The document presents diagrams for two microscope models with callouts identifying their parts.

**Model AY11240 (Left):**
- **Optical System:** Eyepiece, Barrel, Revolving Turret, Objectives.
- **Stage/Platform:** Stage, Spring Clips, 5-Hole Diaphragm and Condenser, Concave Mirror.
- **Adjustment/Structure:** Coarse Adjustment Knob, Fine Adjustment Knob, Stand.

**Model AY11238 (Right):**
- **Optical System:** Eyepiece, Eyepiece Set Screw, Monocular Tube, Rotating Head, Revolving Turret, Objectives.
- **Stage/Platform:** Stage, Spring Clips, 5-Hole Diaphragm and Condenser, Stage Height Limit Adjustment.
- **Illumination:** Lamp On/Off Switch, Lamp Power Cord.
- **Adjustment/Structure:** Coarse Adjustment Knob, Fine Adjustment Knob, Stand.
...
BARSKA Model AY11238 features a monocular tube that is slanted at a $45^\circ$ angle. The head rotates $360^\circ$. The Eyepiece Set Screw prevents the eyepiece from falling out of the tube.
