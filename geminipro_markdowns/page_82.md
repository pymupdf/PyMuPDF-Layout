...
**Figure 9-14 (summary):** A dialog box titled "Storage Migration Wizard" showing a diagram of hardware components (Server, Switch, SAN). Text reads: "The data migration has begun. After it is completed use the finalize action in the Migration panel of the management GUI to remove the image-mode volume copies. Then unzone and remove the original storage system." The **Finish** button is highlighted.
...
**Figure 9-15 (summary):** A screenshot of the "Storage Migration" table interface.
- **Button bar:** Start New Migration, Actions, Download icon, View filters.
- **Table Headers:** Volume Name, Target Pool, Status, Progress, UID.
- **Row Data:** 
  - Volume Name: `controller0_00000000...`
  - Target Pool: `Test Pool`
  - Status: `Online` (with green checkmark)
  - Progress: `15%` (blue progress bar)
  - UID: `600507680C98B0004800000000000034`
...
26       controller0_0000000000000000  0       17       181016175637
