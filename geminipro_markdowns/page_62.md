![ECHA European Chemicals Agency](placeholder-echa-logo.png)

## 4. FORM AND CONTENT OF THE TENDER

### 4.1. Form of the tender: how to submit the tender?

Tenders are to be submitted via the e-Submission application according to the instructions laid down in the Invitation to tender letter and the [e-Submission Quick Guide](placeholder-link).

> ☝️ Make sure you prepare and submit your electronic tender in e-Submission early enough to ensure it is received within the deadline specified under Heading IV.2.2 of the contract notice. A tender received after this deadline will be rejected.
