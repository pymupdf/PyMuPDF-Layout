...
## 2004 Exploration Summary

### Expenditure by Category

![2004 Exploration Expenditure by Category](placeholder-expenditure-category.png)

**Figure (summary):** A pie chart showing the breakdown of exploration expenditure by category.
...
![2004 Exploration Expenditure by Region](placeholder-expenditure-region.png)

**Figure (summary):** A pie chart showing the breakdown of exploration expenditure by region.
...
![Map of Kutei Basin operations](kutei-basin-map.png)

**Figure (summary):** A map of the Kutei Basin in Kalimantan, Indonesia, showing Santos' operational areas. Key locations include Balikpapan, Samarinda, and Bontang. It highlights the Popodi PSC, Donggala PSC, and Papalang PSC areas. The map includes a legend for infrastructure and fields:
*   **Oil field**
*   **Gas field**
*   **Oil pipeline**
*   **Gas pipeline**