---
title: "United States Patent: US 6,482,565 B1"
date: 2002-11-19
inventors: "Jae Chang Jung et al."
---
...
The present invention relates to a cross-linker for use in a photoresist which is suitable for a photolithography process using $\ce{KrF}$ (248 nm), $\ce{ArF}$ (193 nm), E-beam, ion beam or EUV light source. According to the present invention, preferred cross-linkers comprise a copolymer having repeating units derived from: (i) a compound represented by following Chemical Formula 1 and/or (ii) one or more compound(s) selected from the group consisting of acrylic acid, methacrylic acid and maleic anhydride.

**<Chemical Formula 1>**

![Chemical Formula 1: Monomer structure](chemical-formula-1.png)

**Chemical Formula 1 (Description):** A vinyl monomer structure $H_2C=C(R_3)-R-\text{Ring}$, where the Ring is a five-membered 1,3-dioxolane ring substituted at the 2-position with groups $R_1$ and $R_2$.
