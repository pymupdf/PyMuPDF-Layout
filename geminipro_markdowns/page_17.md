...
**Figure 2 (summary):** Two graphs plotting Potential Outcome $Y_t$ against Treatment Level $t$.
- **Left:** Concave Treatment Response Function (slope decreases as $t$ increases).
- **Right:** Convex Treatment Response Function (slope increases as $t$ increases).
