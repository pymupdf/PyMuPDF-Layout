```markdown
---
title: "United States Patent US 7,851,130 B2"
...
![Chemical Structure Formula I](formula-I.png)

**(I) Structure Summary:**
The image displays a sulfonium salt structure labeled (I).
*   A central positively charged sulfur atom ($S^+$) is connected to three aromatic groups.
*   Top group: A phenyl ring substituted with groups $R^{10}$, $R^{11}$, and $R^{12}$.
*   Bottom group: Two benzene rings connected to each other via a linking group $Z$.
    *   The left ring is substituted with $R^{13}$, $R^1$, $R^2$, and $R^3$.
    *   The right ring is substituted with $R^9$, $R^8$, $R^7$, $R^6$, $R^5$ and $R^4$.
*   A counter anion $X^-$ is present separately.
