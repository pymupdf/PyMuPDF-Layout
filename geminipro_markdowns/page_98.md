...
![Map of Brantas PSC and surrounding assets](brantas-psc-map.png)

**Figure: BRANTAS PSC (summary)** This map displays Santos' assets in the Java Sea, offshore of East Java, Indonesia. It shows the locations of several Production Sharing Contracts (PSCs), including Brantas PSC, Sampang PSC, Bawean 1 PSC, Madura Offshore PSC, and Nth Bali 1 PSC. Key onshore locations like Surabaya and Grati are marked. The map includes a legend indicating:
- Santos acreage
