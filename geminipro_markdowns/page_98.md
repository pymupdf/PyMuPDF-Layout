```yaml
---
document_title: Santos Annual Report 2004 - Page 23
---
```
...
![Figure: Brantas PSC Map](brantas-psc-map.png)

**Figure: BRANTAS PSC (Summary)**
A map displaying the East Java region, including Bawean Island, Madura Island, Surabaya, and Bali. It details the infrastructure and fields within the Brantas PSC and surrounding areas:
*   **Fields:** Jeruk, Oyong, Maleo (Gas), Banyuang, and Ujung Pangkah.
*   **Boundaries:** Sampang PSC, Madura Offshore PSC, Nth Bali 1 PSC.
*   **Legend items:** Santos acreage, Santos acreage acquired through Novus acquisition, Oil field, Gas field, Oil pipeline, Gas pipeline.
*   Scale is approximately 0 to 50 kilometres.
