...
(1.1)
$$
a_{k+t} - a_{(p-1)+t} = a_{p-k} - a_1 \quad \text{for all } 0 \le k \le p-1
$$
...
(1.2)
$$
a_{k+t} = a_{p-k} = a_{-k} \quad \text{for all } 0 \le k \le p-1
$$
...
(1.3)
$$
\left(\sum_{k=0}^{p-2} a_k\right) x \equiv -\sum_{k=0}^{p-2} k a_k \pmod{p}
$$
...
(1.4)
$$
\left(\sum_{k=0}^{p-1} a_k\right) x \equiv -\sum_{k=0}^{p-1} k a_k \pmod{p}
$$
