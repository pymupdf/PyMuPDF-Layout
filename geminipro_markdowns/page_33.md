...
![Airport Sketch illustrating runway layout, lighting, and approach data](airport-sketch.png)

**Figure (summary):** The airport sketch provides key visual data for an airport. It displays:
-   **Header Information:** Airport Elevation (ELEV 5434) and Touchdown Zone Elevation (TDZE 5352).
-   **Runways:** Multiple intersecting runways are shown with labels like 34R, 34L, 35L, 35R. Dimensions are provided (e.g., 16000 X 200, 12000 X 150). Runway slopes are indicated (e.g., 0.5% UP).
-   **Lighting Notes:** A box details lighting systems available for specific runways.
    -   `TDZ/CL Rwys 7, 16L, 16R, 17R, 26, 34L, 34R, 35L, 35R`
    -   `HIRL All Rwys`
-   **Navigation Aid:** A final approach fix (FAF) is noted as `082° 5 NM from FAF`.
...
![Diagram illustrating the components of a runway depiction on an airport chart](runway-diagram-components.png)

**Figure (summary):** This diagram breaks down the symbols and information shown for a single runway on an airport chart. It labels the following elements:
-   **HS 1:** Hot Spot
-   **Runway Slope:** 0.7% UP
-   **BAK-12:** Arresting gear
