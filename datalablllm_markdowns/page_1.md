...
$$\underset{p_{n,k,l}}{\text{minimize}} \quad \log_{2} \prod_{l=1}^{L} \prod_{k=1}^{K} \prod_{n=1}^{N} \left( \frac{\sigma^{2} + I_{n,l}}{p_{n,k,l} h_{n,k,l} + \sigma^{2} + I_{n,l}} \right)^{\alpha_{n,k,l}}$$

$$\text{subject to} \quad \sum_{n=1}^{N} \alpha_{n,k,l} p_{n,k,l} \leq P_{k,\text{max}}, \quad \forall k, \forall l \tag{12}$$
