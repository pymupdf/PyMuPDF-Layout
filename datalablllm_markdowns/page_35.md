# NAVWEPS 00-80T-80 OPERATING STRENGTH LIMITATIONS
...
$$\Delta n = 0.115 \frac{m\sqrt{\sigma}}{(W/S)} V_{\sigma}(KU)$$

where

 $\Delta n = \text{change in load factor due to gust}$  $m = \text{lift curve slope, unit of } C_{\text{z}} \text{ per degree}$ of  $\alpha$  $\sigma = \text{altitude density ratio}$  $W/S = \text{wing loading, psf}$  $V_{\bullet}$  = equivalent airspeed, knots  $KU = \text{equivalent sharp edge}$  gust velocity ft. per sec.
