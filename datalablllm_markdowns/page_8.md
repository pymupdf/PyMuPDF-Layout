...
and therefore, if  $N_{ik}$  is small, or there are degeneracies within  $C_{ij}$ , the inversion will be affected. This problem can be eliminated by performing a Single Value Decom $position (SVD)$  of the matrix,

$$C_{ij} = U_{ik}^{\dagger} D_{kl} V_{lj}, \qquad (15)$$
...
## Α. Statistical determination of large scale flow
...
## В. Reconstruction of matter density field from $v_p$
