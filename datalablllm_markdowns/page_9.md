...
$$X = \begin{pmatrix} l_a - 302.1 \\ R - 1.71 \\ z_* - 1090.04 \end{pmatrix}$$
 (23)

and the inverse covariance matrix

$$C_M^{-1} = \begin{pmatrix} 1.8 & 27.968 & -1.103\\ 27.968 & 5667.577 & -92.263\\ -1.103 & -92.263 & 2.923 \end{pmatrix}$$
(24)
...
In summary,  $\mathcal{L}$ 

$$\chi_{total}^{2} = \tilde{\chi}_{sn}^{2} + \chi_{cmb}^{2} + \chi_{bao}^{2} + \chi_{H}^{2}.$$
 (26)
...
| Models  | $\widetilde{\chi}^2_{sn,min}$ | $\chi^2_{cmb,min}$ | $\chi^2_{bao,min}$ | $\chi^2_{H,min}$ | $\chi^2_{total,min}$ |
|---------|-------------------------------|--------------------|--------------------|------------------|----------------------|
