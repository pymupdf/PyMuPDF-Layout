...
voltage regulation logic to change an operating voltage of the first integrated circuit, the voltage regulation logic to receive a signal from the proaram.

- **15.** The apparatus of claim 10, wherein the instructions reside in a Basic Input Output System.
- **16.** The apparatus of claim 10, wherein the instructions 20 reside in an operating system.
...
- 30 **26.** The machine-readable medium of claim 23, further comprising instructions which, when executed by the machine, cause the machine to perform the further operations comprising:
- 35 operating the integrated circuit at the third state of performance for a transient period of time.
