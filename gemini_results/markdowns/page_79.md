...
![Figure 3-7: IBM Cloud Pak for Automation](figure-3-7.png)

**Figure 3-7 (summary):** A structural diagram of the platform stack:
1.  **IBM containerized software** (Top layer): Includes components for Tasks, Workflow, Decisions, Content, Capture, and Operational Intelligence.
2.  **Operational services** (Middle layer): Includes Logging, monitoring, security, and identity access management.
3.  **Red Hat OpenShift** (Base layer).
...
![Figure 3-8: IBM Cloud Pak for Automation benefits](figure-3-8.png)

**Figure 3-8 (summary):** A comparison diagram showing two opposing arrows:
*   **Reduce costs** (Down Arrow):
    *   Improve efficiency of their automated systems
    *   Make employees more efficient
    *   Extract information from unstructured data
*   **Improve top-line** (Up Arrow):
    *   New business models
    *   Find new opportunities for revenue growth
    *   Deliver better (more personalized, more relevant...) products and services
