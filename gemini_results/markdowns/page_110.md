...
$$
A = \frac{([\text{H}] \times 0.04 + [\text{C}] \times 1.0 + [\text{N}] \times 2.1 + [\text{O}] \times 30.6 + [\text{F}] \times 50.6 + [\text{S}] \times 1.5 + [\text{I}] \times 39.5)}{([\text{H}] \times 1 + [\text{C}] \times 12 + [\text{N}] \times 14 + [\text{O}] \times 16 + [\text{F}] \times 19 + [\text{S}] \times 32 + [\text{I}] \times 127)} \quad \text{Formula (1)}
$$
