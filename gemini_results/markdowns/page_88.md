28 | Projects Report | www.kingsgate.com.au
...
![Map of Chile showing the location of the Nueva Esperanza Project](map_chile_nueva_esperanza.png)

**Figure Summary:** A map of Chile illustrating the location of the Nueva Esperanza Project.
- **Location:** Situated in Northern Chile, roughly between 20° and 30° latitude.
- **Nearby Cities:** Located near Copiapó and Chañaral. Other markers include Antofagasta (north), La Serena (south), and Santiago (further south).
- **Neighboring Countries:** Peru, Bolivia, and Argentina are shown bordering Chile.
- **Geographic Details:** An inset globe highlights South America. The map features coordinates (70° W, 20°–50° S) and terrain shading.
