...
![Figure Formula I](formula-I-placeholder.png)

**(Formula I Summary):** The image displays a chemical structure consisting of a sulfonium cation ($S^+$) bonded to three aryl groups. Two of the aryl groups are fused together via a linking group $Z$, forming a tricyclic system with the central sulfur atom. The third aryl group is attached directly to the sulfur. The rings are substituted with groups $R^1$ through $R^{13}$. An associated anion is denoted as $X^-$.
