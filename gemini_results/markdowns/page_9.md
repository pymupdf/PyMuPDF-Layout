...
$$
\chi^2_H = \sum_{i=1}^{12} \frac{[H(z_i) - H_{ob}(z_i)]^2}{\sigma_i^2}.
\tag{25}
$$
...
$$
\chi^2_{total} = \tilde{\chi}^2_{sn} + \chi^2_{cmb} + \chi^2_{bao} + \chi^2_H.
\tag{26}
$$
...
| Models | $\tilde{\chi}^2_{sn,min}$ | $\chi^2_{cmb,min}$ | $\chi^2_{bao,min}$ | $\chi^2_{H,min}$ | $\chi^2_{total,min}$ |
| :--- | :---: | :---: | :---: | :---: | :---: |
| Model I | 459.728 | 0.204 | 1.494 | 5.983 | 467.409 |
| CPL | 465.621 | 0.251 | 1.716 | 10.818 | 478.406 |
| $\Lambda$CDM | 465.759 | 1.014 | 1.470 | 10.850 | 479.093 |
