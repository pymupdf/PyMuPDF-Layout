![ECHA European Chemicals Agency](echa_logo_placeholder.png)

services for which these capacities are required (i.e. the latter will assume the role of subcontractors).

> ☝️ **Note:** Relying on the capacities of other entities is only necessary when the capacity of the tenderer is not sufficient to fulfil the required minimum levels of capacity. Abstract commitments that other entities will put resources at the disposal of the tenderer will be disregarded.
