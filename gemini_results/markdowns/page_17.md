...
**Figure 2 (summary):** Two line graphs plotting Potential Outcome $Y_t$ against Treatment Level $t$.
- **Left:** Concave Treatment Response Function. The curve starts at the origin and rises with a decreasing slope (concave down).
- **Right:** Convex Treatment Response Function. The curve starts flat and rises with an increasing slope (convex up).
