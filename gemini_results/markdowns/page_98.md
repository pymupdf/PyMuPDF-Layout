...
Also during the first half of 2004, Santos divested its remaining 18.4% shareholding in Magellan Petroleum Australia Ltd, raising approximately $10.6 million.
...
![Map: Brantas PSC](placeholder-brantas-psc.png)

**Figure: BRANTAS PSC (Summary)**
A map illustrating the geographic layout of the Brantas PSC region in the Java Sea, specifically around East Java and Madura Island.
- **Geography:** Shows Surabaya, Grati, Bawean Island, and Madura Island.
- **Fields:** Marks locations of "Jeruk", "Oyong", "Maleo" (Madura Island PSC), and "Nth Bali 1 PSC".
- **Infrastructure:** Indicates pipelines connecting the offshore fields to the mainland near Grati and Surabaya.
- **Legend:**
  - White blocks: Santos acreage
  - Bold outline blocks: Santos acreage acquired through Novus acquisition
  - Black squares: Oil field
  - Grey squares: Gas field
  - Black lines: Oil pipeline
  - Grey lines: Gas pipeline
- **Scale:** Includes a scale bar spanning 0 to 50 kilometres.
