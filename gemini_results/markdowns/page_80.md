...
![Example of #REF! error in Excel](excel-ref-error.png)

**Figure (summary):** An Excel interface screenshot showing a cell displaying the `#REF!` error. The formula bar shows `=#REF!+L12`. A red arrow and text annotation point to the cell, reading: "#REF! error in an Excel formula".
