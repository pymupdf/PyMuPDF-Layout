...
| :---: | --- |
| **5** | **MEA VHF and RNAV Example** |

![Figure 5: MEA VHF and RNAV Example chart segment](figure-5.png)

**Figure 5 (summary):** 
A segment of Airway V465 between waypoints LUNDI and OLNUE.
- **Distances:** 35 NM and 51 NM.
- **Altitudes listed:**
  - **15000** (Blue): MEA for VHF NAVAID.
  - **13300G** (Blue): MEA for RNAV.
  - ***13300**: MOCA.
- **Note:** "MEA GAP" is indicated along the route.
...
| Reference Number | Description |
| :---: | --- |
| **6** | **MCA and MTA Example at a NAVAID** |

![Figure 6: Jackson NAVAID Data Block with MCA and MTA information](figure-6.png)

**Figure 6 (summary):** 
A NAVAID data box for **JACKSON**.
- **Frequency:** 122.05 (Communication), 115.4 (NAVAID).
- **ID:** JAC (`.--- .- -.-.`), Chan 101.
