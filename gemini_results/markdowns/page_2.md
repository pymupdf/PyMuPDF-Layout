---
title: "Semiconducting-enriched single wall carbon nanotube networks applied to field effect transistors"
authors: "N. Izard, S. Kazaoui*, K. Hata, T. Okazaki, T. Saito, S. Iijima, and N. Minami"
...
date: "2010-01-06"
arxiv_id: "arXiv:1001.0892v1 [cond-mat.mtrl-sci]"
---

> **Note:** The following document contains the text extracted from the provided PDF page.
...
**Figure 1 Summary:**
*   **(a) Absorbance vs Wavelength (nm):** Shows distinct peaks labeled M11 (metallic) and S22, S11 (semiconducting transitions). The red line (Sample S) shows suppressed M11 peaks compared to the black line.
*   **(b) Normalized Intensity vs Wavenumber (cm⁻¹):** Comparison of Radial Breathing Modes (RBM) for s-SWNT (red) vs m-SWNT (black).
*   **(c) Transfer Characteristic:** Log plot of Drain Current ($I_D$) versus Gate Voltage ($V_G$). Sample S (red line) shows a high On/Off ratio (ranging from approx $10^{-5}$ to $10^{-10}$ A) typical of p-type semiconductor behavior, while Sample M (blue line) shows weak modulation.
...
*[Note: The reference list is not included in the provided document page, but citations [1-16] appear in the text.]*