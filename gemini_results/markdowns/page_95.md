![Australian School of Petroleum building](school-of-petroleum.png)
...
Santos is committed to achieving effective emission reduction targets, to the pursuit of energy efficiency strategies and to the identification and implementation [of measures...]

### OIL SPILL VOLUMES

![Line graph showing Oil Spill Volumes from 2001 to 2004](oil-spill-volumes-graph.png)

**Figure Summary (Oil Spill Volumes in $m^3$):**

| Year | Volume ($m^3$) | Notes |
| :--- | :--- | :--- |
| '01 | ~400 | Stable |
| '02 | ~400 | Stable |
| '03 | 1,943 | Peak (Labelled: "Lytton oil spill effect") |
| '04 | 83 | Significant reduction |
