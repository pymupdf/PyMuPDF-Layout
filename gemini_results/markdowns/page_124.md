...
The present invention relates to a cross-linker for use in a photoresist which is suitable for a photolithography process using KrF (248 nm), ArF (193 nm), E-beam, ion beam or EUV light source. According to the present invention, preferred cross-linkers comprise a copolymer having repeating units derived from: (i) a compound represented by following Chemical Formula 1 and/or (ii) one or more compound(s) selected from the group consisting of acrylic acid, methacrylic acid and maleic anhydride.

![Chemical Formula 1](placeholder-chemical-formula-1.png)

**Chemical Formula 1 (summary):** A vinyl monomer structure ($\ce{H2C=C(R3)-}$) connected via a spacer group ($R$) to a 1,3-dioxolane ring substituted with $R_1$ and $R_2$.

wherein, $R_1$, $R_2$ and $R$ individually represent straight or branched $\text{C}_{1-10}$ alkyl, straight or branched $\text{C}_{1-10}$ ester, straight or branched $\text{C}_{1-10}$ ketone, straight or branched $\text{C}_{1-10}$ carboxylic acid, straight or branched $\text{C}_{1-10}$ acetal, straight or branched $\text{C}_{1-10}$ alkyl including at least one hydroxyl group, straight or branched $\text{C}_{1-10}$ ester including at least one hydroxyl group, straight or branched $\text{C}_{1-10}$ ketone including at least one hydroxyl group, straight or branched $\text{C}_{1-10}$ carboxylic acid including at least one hydroxyl group, and straight or branched $\text{C}_{1-10}$ acetal including at least one hydroxyl group; $R_3$ represents hydrogen or methyl; $m$ represents 0 or 1; and $n$ represents a number of 1 to 5.
