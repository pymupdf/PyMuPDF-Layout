---
title: "BARSKA Microscope User Manual: Models AY11240 & AY11238"
---
...
2. This instrument should only be used in an environment with an indoor temperature range of 32°F to 104°F.
...
![Diagrams of Model AY11240 and Model AY11238](microscope_diagrams.png)

**Figure Summary: Microscope Components**

The figure displays two microscope models with labeled parts:

**Model AY11240 (Left - Fixed Tube Type):**
*   **Eyepiece**
*   **Barrel**
*   **Revolving Turret** holding **Objectives**
*   **Spring Clips** on the **Stage**
*   **Concave Mirror** at the base
*   **Stand**
*   **Coarse Adjustment Knob** and **Fine Adjustment Knob** (side-mounted)
*   **5-Hole Diaphragm and Condenser** (under stage)

**Model AY11238 (Right - Monocular Tube Type):**
*   **Monocular Tube** with **Eyepiece** and **Eyepiece Set Screw**
*   **Rotating Head**
*   **Revolving Turret** holding **Objectives**
*   **Stage** with **Spring Clips**
*   **Stage Height Limit Adjustment**
*   **Coarse Adjustment Knob** and **Fine Adjustment Knob**
*   **5-Hole Diaphragm and Condenser**
*   **Lamp**, **Lamp On/Off Switch**, and **Power Cord**
