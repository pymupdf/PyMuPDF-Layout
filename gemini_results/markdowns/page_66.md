...
> *Note: Text cuts off in original source document.*

---

# MODEL AY11236

![Model AY11236 Diagram](model-ay11236-diagram.png)

**Figure: Model AY11236 Components**
The diagram labels the following parts of the microscope:
*   **Top/Head:** Eyepiece, Rotating Head, Interpupillary Slide Adjustment.
*   **Body/Optics:** Revolving Turret, Objectives, Stage.
*   **Base/Controls:** Condenser Focusing Knob, Lamp On/Off Switch, Stand, Coarse Adjustment Knob, Fine Adjustment Knob, Stage Clip Adjustment, Power Cord, Lamp.
