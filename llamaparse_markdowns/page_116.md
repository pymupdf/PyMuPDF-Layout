...
1. A pattern forming method, including:
   ...
   (c) developing the exposed film by using a developer containing an organic solvent to form a negative pattern, wherein a content of the repeating unit represented by Formula (1-0) is 45 mol % or more based on a whole repeating units in the resin (A):

$$
\text{(Formula (1-0) and Formula (1-2) are referenced but not shown on this page)}
$$

----

*Note: The formulas (1-0) and (1-2) are referenced but not included in this page.*
