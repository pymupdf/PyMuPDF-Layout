...
$$
\mathcal{C}(\mathbf{A}_l, \mathbf{P}_l) \geq \frac{1}{L} \sum_{l=1}^L \sum_{k=1}^K \sum_{n=1}^N \alpha_{n,k,l} \log_2 \left( 1 + \frac{p_{n,k,l} h_{n,k,l}}{\sigma^2 + \xi_{n,l}} \right) \tag{8}
$$

where

$$
\xi_{n,l} = \sum_{\substack{j=1 \\ j \neq l}}^L \sum_{k=1}^K P_{k,\max} g_{n,k,j,l}.
$$
