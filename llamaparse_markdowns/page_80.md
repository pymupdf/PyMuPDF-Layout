...
| Formula Bar | Formula Bar | Formula Bar |
| ----------- | ----------- | ----------- |
| =#REF!+L12  |             |             |
...
In the above example, if you click on the cell that contains the `#REF!` error, you will see that the cell reference within the cell has been replaced with `#REF!`. Therefore, in order to fix this error, you need to re-enter the correct cell references into your formula.
