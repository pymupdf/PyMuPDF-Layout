...
| Login   | **Login Message**<br/>The login message will be displayed to anyone logging into the GUI or in a CLI session. | Save Reset |
| ------- | ------------------------------------------------------------------------------------------------------------- | ---------- |
| General | Login message: \[x] Enabled<br/>This is an ITSO-managed system. Unauthorized access is restricted.            |            |
...
Storwize V7000  
Storage Management (ITSO_V7000G2_A)  
