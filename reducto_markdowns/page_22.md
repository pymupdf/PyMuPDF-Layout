...
\[
\mathcal{C}\left(\mathbf{A}_{l}, \mathbf{P}_{l}\right) \geq \frac{1}{L} \sum_{l=1}^{L} \sum_{k=1}^{K} \sum_{n=1}^{N} \alpha_{n, k, l} \log _{2}\left(1+\frac{p_{n, k, l} h_{n, k, l}}{\sigma^{2}+\xi_{n, l}}\right)
\]
...
\[
Q_{n, k, l}=\frac{p_{n, k, l} h_{n, k, l}}{\xi_{n, l}+\sigma^{2}}
\]
