...
The figure shows three types of analysis (optical absorption, Raman spectroscopy, and electrical measurements) comparing different single-wall carbon nanotube samples labeled L, M, and S. Panel (a) displays optical absorption spectra showing characteristic peaks for semiconducting nanotubes across wavelengths from 600-1600 nm, while panel (b) shows Raman spectra with distinct metallic and semiconducting peaks. Panel (c) demonstrates the transfer characteristics of field-effect transistors made from samples M and S, with sample S showing superior semiconducting behavior indicated by a higher on/off current ratio.

FIG. 1: (Color online): (a) shows the optical absorption spectra and (b) the Raman spectra at 514.5 nm of L, M and S samples . (c) displays the transfer characteristic, \( I_{D} \) vs \( V_{G} \) for \( V_{D S}=-14 \mathrm{V} \) of FET devices made of sample M and S.
