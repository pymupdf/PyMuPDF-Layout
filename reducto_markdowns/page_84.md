...
The image shows the Encryption Licenses window displaying information about control enclosures with columns for Type, M/T-M, S/N, and Licensed status. A right-click context menu is open on a Control Enclosure entry (2076-), showing two license activation options: "Activate License Automatically" and "Activate License Manually". The interface allows users to select either automatic or manual encryption license activation for their chosen control enclosure.
