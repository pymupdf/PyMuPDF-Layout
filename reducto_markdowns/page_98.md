...
This map shows Santos' petroleum exploration and production assets in the Java Sea region of Indonesia, including several Production Sharing Contracts (PSCs) such as Brantas, Sampang, Madura Offshore, and North Bali. The map displays Santos' acreage in white outlines, with some areas acquired through the Novus acquisition shown with different markings, along with existing oil and gas fields and pipeline infrastructure. The region spans from Surabaya in East Java northward to include various offshore blocks and extends eastward toward Bali.
