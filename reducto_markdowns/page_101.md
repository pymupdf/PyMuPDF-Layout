...
This map shows the Kutei Basin region in Indonesia, featuring various oil and gas fields including the Popodi PSC, Donggala PSC, and Papalang PSC areas. The map displays both oil fields (shown in dark gray) and gas fields (shown in light gray), along with their corresponding pipeline networks across the Makassar Strait area. Key locations marked include Kalimantan, Sulawesi, and several coastal cities like Balikpapan, with a scale indicating the region spans approximately 50 kilometers.
