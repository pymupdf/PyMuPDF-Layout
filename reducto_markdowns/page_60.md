...
denominated in euro, identified as follows:

Name of bank: <empty>
Full address of branch: <empty>
Exact denomination of account holder: <empty>
Full account number including bank codes: <empty>
IBAN code: <empty>
...
of this FWC, communications must be sent to the following addresses:
