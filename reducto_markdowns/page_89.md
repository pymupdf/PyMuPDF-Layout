...
The image shows a historical telephone directory from 1906 for "The Farmers' Mutual Telephone System of Shenandoah County." The aged, yellowed cover includes listings for stock-holders and phone-holders along with their respective calls and locations. This represents an early example of the type of regional directory service that Shentel later expanded in 2003 based on customer survey results showing 60% would use a six-county directory.
...
The image shows the cover of the 2004 ShentelPages directory, featuring a map-shaped collage of local landmarks and scenes from the six-county service area. The cover prominently displays "SHENTELPages" at the top and "2004 AREA CODE 540" at the bottom right. The design incorporates various photographs of buildings, landscapes, and community scenes overlaid on what appears to be a geographic outline of the coverage region.
