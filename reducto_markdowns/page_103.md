...
This organizational chart illustrates SMFG's risk management system structure, showing the hierarchical relationship between the Board of Directors, Management Committee, and various risk management departments. The diagram displays how guidance flows from SMFG's corporate level down through subsidiaries like SMBC, SMBC Nikko Securities, and other financial entities in the center column. Each entity has designated risk management functions including credit risk, market risk, operational risk, and liquidity risk management, with reporting and monitoring mechanisms connecting all levels of the organization.
