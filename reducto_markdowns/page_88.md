...
This map shows the location of the Nueva Esperanza project in northern Chile, positioned between Peru and Bolivia. The map displays several cities along Chile's coast including Antofagasta, Chañaral, La Serena, and Santiago, with Copiapo also marked inland. A small globe inset shows the regional context of South America with the project location highlighted.
...
A feasibility study for a decision to mine the Arqueros portion of Nueva Esperanza was completed in late 2012, demonstrating that open pit mining at two million tonnes per year and processing by milling and agitation leaching in cyanide was technically feasible. Work remained to integrate the Teterita and Chimberos deposits into the project, as well as to test lower cost options for processing. Continued metallurgic al testwork has shown that mineralisation from all three deposits by heap leaching is technically and economically feasible and the preferred alternative for development.
