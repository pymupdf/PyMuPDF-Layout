...
Tenders must be submitted exclusively via the electronic submission system (e-Submission) available from the above website2 and accessible on the Funding and Tenders Opportunities portal (F&T portal)3, Tenders submitted in any other way (e.g. e-mail or by letter) will be disregarded.
...
2 For detailed instructions on how to submit a tender please consult the e-Submission Quick Guide available at: https://webgate.ec.europa.eu/digit/opsys/esubmission/assets/documents/manual/quickGuide en.pdf.
