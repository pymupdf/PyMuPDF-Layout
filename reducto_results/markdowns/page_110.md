...
[0049] The resist composition satisfies Condition 1. As described above, in a case where the A value defined in Condition 1 is high, the absorption efficiency of EUV light of the resist film formed with the resist composition is increased. The A value represents the absorption efficiency of EUV light of the resist film in terms of a mass ratio. [0050] Condition 1: The A value determined by Formula (1) is 0.14 or more.

A=([H]×0.04+[C]×1.0+[N]×2.1+[O]×30.6+[F]×50.6+
[S]×1.5+[1]×39.5)/([H]x1+[C]x12+[N]x14+[O]×
16+[F]×19+[S]x32+[I]×127) Formula (1):
