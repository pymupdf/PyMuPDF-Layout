...
- Subtext: "The login message will be displayed to anyone logging into the GUI or in a CLI session."
- Left navigation: "Login" (selected), "General"
- Login message control:
  - Label: "Login message:"
  - Checkbox: "Enabled" (checked)
  - Textbox content (visible): "This is an ITSO-managed system. Unauthorized access is restricted."
- Top-right buttons: "Save", "Reset"

Figure 5-80 Enabling login message

The resulting log-in screen is shown in Figure 5-81.

Storwize V7000 login screen:
*   Fields: Username, Password.
*   Button: Sign In.
*   Message: "This is an ITSO-managed system. Unauthorized access is restricted."
