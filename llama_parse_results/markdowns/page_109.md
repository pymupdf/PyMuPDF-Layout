...
**(1-0)**  
Chemical structure showing: Ra connected to a carbon chain with R1 and R2 substituents, and R11, R12, R13 groups attached to a cyclic structure

**(1-2)**  
Chemical structure showing: Rb connected to L2 linker, which connects to a cyclic structure with (R3n2) and (OH)n1 substituents
