...
[Figure 7: A phase plot showing trajectories in the y<sub>1</sub>-y<sub>2</sub> plane. The plot shows two sets of curves - red arcs and blue arcs - both approaching a periodic solution. The y<sub>1</sub> axis ranges from -0.2 to 1.2, and the y<sub>2</sub> axis ranges from -2 to 2. The trajectories show two symmetric branches, one in the upper half (around y<sub>2</sub> = 1 to 1.5) and one in the lower half (around y<sub>2</sub> = -1 to -1.5), both decreasing as y<sub>1</sub> increases.]
...
$$x'_2 = -0.0001[x_2^2 + (x_1 - 1)^2 - 1]x_2 - x_1 + 1, \tag{5.71}$$
