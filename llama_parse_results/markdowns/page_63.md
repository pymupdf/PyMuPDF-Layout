...
**Product names and trademarks**: whenever the technical specifications mention a specific product name or trademark and a sufficiently precise and fully intelligible description is not possible, such mention should be understood as referring to that product <ins>or its equivalent</ins>, unless otherwise provided for in the Terms of Reference.
