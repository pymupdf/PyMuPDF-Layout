...
The page includes a map of Texas showing the Eagle Ford formation with the following geological windows marked:
- Oil Window (in Maverick and Atascosa counties)
- Volatile Oil & Condensate Window (in Dimmit, McMullen, and Live Oak counties)
- Dry Gas Window (in the southeastern portion)

The map shows SEA Field Office and SEA Acreage locations within the formation boundaries.