...
[Figure: A line graph with x-axis labeled "Mode Number" ranging from 0 to 25, and y-axis labeled "λ<sub>i</sub>" with logarithmic scale from 0.01 to 10. The line shows a steep decline from high values near mode 0, dropping sharply until about mode 10, then gradually flattening out towards mode 25.]
