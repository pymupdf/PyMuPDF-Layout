...
[Chemical Structure 1: Shows a polymer unit with CH₃ group, CH₂-C backbone, O=C linkage, and a complex cyclic structure with CF₃ and OH groups]

[Chemical Structure 2: Shows a polymer unit with H, CH₂-C backbone, O=C linkage, and a cyclic structure with CF₃ and OH groups]
...
The examples of such monomers include compounds having one addition polymerizable unsaturated bond selected from acrylic esters, methacrylic esters, acrylamides, meth-acryl-amides, allyl compounds, vinyl ethers, vinyl esters, etc.
