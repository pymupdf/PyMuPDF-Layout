...
$$V(E) = \begin{cases} \frac{\kappa_a^2}{\pi\kappa_0^2}\sqrt{1-\left(\frac{E}{2\kappa_0}\right)^2} & -2\kappa_0 < E < 2\kappa_0 \\ 0 & |E| > 2\kappa_0 \end{cases} \quad (49)$$
...
| Plot Position | Parameter Values | Description                                                    |
| ------------- | ---------------- | -------------------------------------------------------------- |
| Top Left      | Re(Ea)/κ0 = 0    | Triangular shaded region from (0,0) to approximately (±1, 1.6) |
| Top Right     | Re(Ea)/κ0 = ±0.5 | Narrower triangular shaded region, reduced width               |
| Bottom Left   | Re(Ea)/κ0 = ±1   | Further narrowed triangular region                             |
| Bottom Right  | Re(Ea)/κ0 = ±1.8 | Very narrow triangular region near the axes                    |
