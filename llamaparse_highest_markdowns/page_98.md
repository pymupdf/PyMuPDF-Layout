...
[Map showing the Brantas PSC area in Indonesia, featuring various islands and locations including:
- Bawean 1 PSC and Bawean Island in the north
- Java Sea in the central area
- Sampang PSC near Madura Island
- Surabaya on the mainland
- Brantas PSC area marked with boundaries
- Various other locations including Jeruk, Oyong, Maleo, and other fields
- Nth Bali 1 PSC and East Java regions
- Kangean Islands to the east
- Bali in the southeast

The map includes a scale bar showing 0 to 50 kilometers and a legend indicating:
- Santos acreage (shown in light shading)
- Santos acreage acquired through Novus acquisition (shown in darker shading)  
- Oil field (black squares)
- Gas field (white squares)
- Oil pipeline (black lines)
- Gas pipeline (gray lines)]
