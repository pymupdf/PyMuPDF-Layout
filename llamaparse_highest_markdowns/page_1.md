...
$$\text{minimize}_{p_{n,k,l}} \log_2 \prod_{l=1}^L \prod_{k=1}^K \prod_{n=1}^N \left(\frac{\sigma^2 + I_{n,l}}{p_{n,k,l}h_{n,k,l} + \sigma^2 + I_{n,l}}\right)^{\alpha_{n,k,l}}$$ (12)

$$\text{subject to} \sum_{n=1}^N \alpha_{n,k,l}p_{n,k,l} \leq P_{k,\text{max}}, \forall k, \forall l$$
...
$$\sum_{l=1}^L \sum_{k=1}^K u_{n,k,l}(p) \geq \prod_{l=1}^L \prod_{k=1}^K \left(\frac{u_{n,k,l}(p)}{s_{n,k,l}}\right)^{s_{n,k,l}}$$ (13)
