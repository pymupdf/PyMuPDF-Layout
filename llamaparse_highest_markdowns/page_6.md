...
The page shows a 3x3 grid of plots with the following parameter combinations:

Row 1: k1=1, k2=1 | k1=1, k2=10 | k1=1, k2=40
Row 2: k1=5, k2=1 | k1=5, k2=10 | k1=5, k2=40  
Row 3: k1=10, k2=1 | k1=10, k2=10 | k1=10, k2=40
...
F<sub>0</sub> and F<sub>1</sub> over the support causes more triangles having positive probability lower bounds, which leads the improvement of my new lower bound. On the other hand, the Makarov lower bound gets no such informational gain because it uses only one triangle while my new lower bound takes advantage of *multiple* triangles.
